...
|---|---|---:|---:|---:|---:|---:|---:|
| `accounts/fireworks/models/deepseek-v4-flash-0731` | unknown | 200 | 67.0% | 4.88 | 16.57 | 1.5% | $0.000670 |
| `accounts/fireworks/models/deepseek-v4-flash-0731` | overall | 200 | 67.0% | 4.88 | 16.57 | 1.5% | $0.000670 |

## Per-database accuracy

| db_id | N | Exec Acc |
|---|---:|---:|
| `sales_in_weather` | 50 | 56.0% |
| `soccer_2016` | 50 | 64.0% |
| `restaurant` | 50 | 66.0% |
| `movie` | 50 | 82.0% |
...
- `movie` #746 (unknown): Result sets differ (category: wrong-result)
...
- `restaurant` #1672 (unknown): Result sets differ (category: wrong-result)
- `restaurant` #1699 (unknown): Result sets differ (category: wrong-result)
- `restaurant` #1699 (unknown): Result sets differ (category: wrong-result)
...
- `restaurant` #1765 (unknown): Result sets differ (category: wrong-result)
- `restaurant` #1765 (unknown): Result sets differ (category: wrong-result)
...
- `restaurant` #1783 (unknown): Result sets match (category: wrong-result)
- `sales_in_weather` #8141 (unknown): No generated SQL (category: structured-output-failed)
...
- `sales_in_weather` #8147 (unknown): Result sets differ (category: wrong-result)
- `sales_in_weather` #8148 (unknown): No generated SQL (category: structured-output-failed)
...
- `sales_in_weather` #8212 (unknown): Result sets differ (category: wrong-result)
- `sales_in_weather` #8216 (unknown): Result sets differ (category: wrong-result)
