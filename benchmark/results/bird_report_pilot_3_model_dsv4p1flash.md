...
|---|---|---:|---:|---:|---:|---:|---:|
| `accounts/fireworks/models/deepseek-v4p1-flash` | unknown | 200 | 72.0% | 1.56 | 13.30 | 1.5% | $0.000287 |
| `accounts/fireworks/models/deepseek-v4p1-flash` | overall | 200 | 72.0% | 1.56 | 13.30 | 1.5% | $0.000287 |

## Per-database accuracy

| db_id | N | Exec Acc |
|---|---:|---:|
| `sales_in_weather` | 50 | 64.0% |
| `soccer_2016` | 50 | 64.0% |
| `restaurant` | 50 | 76.0% |
| `movie` | 50 | 84.0% |
| **macro (mean over databases)** | 4 DBs | 72.0% |
...
- `sales_in_weather` #8183 (unknown): Result sets differ (category: wrong-result)
- `sales_in_weather` #8186 (unknown): Result sets match (category: repair-exhausted)
- `sales_in_weather` #8186 (unknown): Result sets match (category: repair-exhausted)
