...
|---|---|---:|---:|---:|---:|---:|---:|
| `accounts/fireworks/models/deepseek-v4-flash-0731` | unknown | 200 | 67.0% | 5.89 | 26.93 | 0.0% | $0.001088 |
| `accounts/fireworks/models/deepseek-v4-flash-0731` | overall | 200 | 67.0% | 5.89 | 26.93 | 0.0% | $0.001088 |

## Per-database accuracy

| db_id | N | Exec Acc |
|---|---:|---:|
| `sales_in_weather` | 50 | 54.0% |
| `soccer_2016` | 50 | 62.0% |
| `restaurant` | 50 | 72.0% |
| `movie` | 50 | 80.0% |
| **macro (mean over databases)** | 4 DBs | 67.0% |
...
- `movie` #746 (unknown): No generated SQL (category: structured-output-failed)
...
- `movie` #766 (unknown): Result sets differ (category: wrong-result)
- `movie` #770 (unknown): No generated SQL (category: rate-limited)
...
- `restaurant` #1672 (unknown): Result sets differ (category: wrong-result)
- `restaurant` #1737 (unknown): No generated SQL (category: rate-limited)
...
- `soccer_2016` #2022 (unknown): Result sets differ (category: wrong-result)
- `soccer_2016` #2023 (unknown): No generated SQL (category: wrong-result)
